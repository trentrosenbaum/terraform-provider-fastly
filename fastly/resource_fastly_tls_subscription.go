...
func resourceFastlyTLSSubscription() *schema.Resource {
	return &schema.Resource{
		...
		Update: resourceFastlyTLSSubscriptionUpdate,
...
func resourceFastlyTLSSubscriptionUpdate(d *schema.ResourceData, meta interface{}) error {
	conn := meta.(*FastlyClient).conn
...
func resourceFastlyTLSSubscriptionDelete(d *schema.ResourceData, meta interface{}) error {
	...
	// FIXME: investigate use of force=true when deleting a subscription with active domains
...
func resourceFastlyTLSSubscriptionStateNotIssued(d *schema.ResourceDiff, _ interface{}) bool {
